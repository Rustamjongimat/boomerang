    ...
    <main className="relative z-10 min-h-screen">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-4 glass border-b border-white/5">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 anim-spin-slow">
            <BoomerangIcon className="w-full h-full" />
          </div>
          <span className="font-outfit font-800 text-xl gradient-text" style={{ fontFamily: "Outfit, sans-serif", fontWeight: 800 }}>
            Smart-Boomerang
          </span>
        </div>
        ...
        <div className="flex items-center gap-3">
          <Link href="/auth/login" className="btn-ghost text-sm py-2 px-5">Kirish</Link>
          <Link href="/auth/register" className="btn-primary text-sm py-2 px-5">Ro'yxatdan o'tish</Link>
        </div>
      </nav>
